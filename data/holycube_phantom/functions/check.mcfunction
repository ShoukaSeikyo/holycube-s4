...
execute store result score #HC4-PhantomCount hc4.phantom at @s run effect give @e[type=minecraft:phantom,tag=hc4_phantom,distance=0..90] minecraft:absorption 1000000 1 true
